...
public class ExampleTimer {
    ...
    public void timerRate() {
        ...
        topList.add(tages.get(10).getName());
        topList.add(tages.get(11).getName());
        topList.add(tages.get(12).getName());
        topList.add(tages.get(13).getName());
        topList.add(tages.get(14).getName());
        topList.add(tages.get(15).getName());
        topList.add(tages.get(16).getName());
        topList.add(tages.get(17).getName());
        topList.add(tages.get(18).getName());
        topList.add(tages.get(19).getName());
        ...
        topNnumber.add(tages.get(10).getNumber());
        topNnumber.add(tages.get(11).getNumber());
        topNnumber.add(tages.get(12).getNumber());
        topNnumber.add(tages.get(13).getNumber());
        topNnumber.add(tages.get(14).getNumber());
        topNnumber.add(tages.get(15).getNumber());
        topNnumber.add(tages.get(16).getNumber());
        topNnumber.add(tages.get(17).getNumber());
        topNnumber.add(tages.get(18).getNumber());
        topNnumber.add(tages.get(19).getNumber());
